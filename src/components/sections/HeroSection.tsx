...
export function HeroSection() {
  ...
  return (
    <section className="relative overflow-hidden bg-background pb-0">
      ...
      <div className="absolute bottom-1/3 right-1/4 w-[400px] h-[400px] bg-purple-600/8 rounded-full blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto pt-20 pb-12">
        ...
        >
          A production quality open source UI component library built with React,
          TypeScript &amp; Tailwind CSS. Copy, customize, and ship stunning
          interfaces in minutes, then contribute back.
        </motion.p>
      ...
      >
        ...
        <div className="absolute -inset-x-8 top-8 h-3/4 bg-brand/10 blur-3xl rounded-full pointer-events-none" />

        {/* Browser chrome frame */}
        <div className="relative rounded-t-2xl overflow-hidden border border-border/60 border-b-0 shadow-2xl shadow-black/30">
          {/* Title bar */}
          ...
          <div className="relative">
            ...
            />
            {/* Bottom gradient fade so the image blends into the next section */}
            <div className="absolute bottom-0 left-0 right-0 h-40 bg-linear-to-t from-background via-background/60 to-transparent pointer-events-none" />
          </div>
        </div>
      </motion.div>
    </section>
